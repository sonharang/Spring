...
public class EmpTestController {
	...
	@ResponseBody
	public Map<String, Object> paramTestEmpGet(String name, Integer age){ //명시X
	...
	@ResponseBody
	public Map<String, Object> paramTestEmpPost(@RequestParam String name, @RequestParam(defaultValue = "20") Integer age){ //명시O required 풀던가 디폴트값 줘야함
		Map<String, Object> map = new HashMap<>();
		map.put("name", name);
		map.put("age", age);
		return map;
